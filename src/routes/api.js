...
router.post("/create-image", cloudinaryImageController.createImage);
...
router.put("/update-image", cloudinaryImageController.updateImage);
...
router.delete(
  "/delete-image/:id",
  authverify,
  cloudinaryImageController.deleteImage
);
